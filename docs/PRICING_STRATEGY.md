...
2. **Reward committed demand.** The customer behaviors that power the forecast (subscriptions, standing orders, pre-orders) always get the best economics. Pricing *is* the incentive design for the data flywheel.
...
- No membership fee at MVP (remove friction; the *data* is the payment). Member pricing 5–8% below Market on subscribed SKUs.
