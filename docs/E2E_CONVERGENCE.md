...
| 7   | Operations      | PARTIAL | Admin + warehouse dashboards + dedicated `/admin/finance` (ledger + invoices + DLQ) live-query. GAP: supplier/executive dashboards (data exists; views not built).                                                                   |
