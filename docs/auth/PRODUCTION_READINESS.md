...
| C5  | Commerce read/write stays on the legacy Prisma schema until each domain migrates per the ERD convergence map — identity bridge (`legacy_account_id`) is live and tested | Eng    |
